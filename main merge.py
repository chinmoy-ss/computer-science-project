...
while tasks=="n":
    ...
    if a6=="A":
        ...
        a="select user_n from creds where user_n=%s"
        cn.execute(a,(uname,))
        con.commit()
        row=cn.fetchone()
        if not row:
                        ...
                        while ty=="y" or ty=="Y":
                            ...
                            if rt=="1":
                                ...
                                while nm=="y" or nm=="Y":
                                    ...
                                    cn.execute("select * from creds where user_n=%s",(oid,))
                                    xb=cn.fetchone()
                                    if xb==None:
                                        print("ID does not exist")
                                    else:
                                        vb="update creds set user_n=%s where user_n=%s"
                            ...
                            if rt=="2":
                                ...
                                while nm=="y" or nm=="Y":
                                    ...
                                    if xm==None:
                                        ...
                                        j="update creds set passwd=%s where user_n=%s"
                    ...
                    if jkl=="b":
                        ...
                        while nm=="y" or nm=="Y":
                            ...
                            if h==None:
                                ...
                                cn.execute("delete from creds where user_n=%s",(oid,))
                                con.commit()
...
--2-to delete data""")
    ...
    #signup functions
        ...
        while y=="y" or y=="Y":
            ...
            cn=con.cursor()
            cn.execute("SELECT * FROM creds WHERE user_n = %s", (us,))

            cc=cn.fetchone()
            if cc==None:
                cn.execute("INSERT INTO creds (user_n, passwd) VALUES (%s, %s)", (us, up))
